...
## Описание
Просмотрите код и опишите (текстово или с картинками) каждую строку с точки зрения происходящего в JVM  
...
//то происходит его загрузка, также превратильно осуществляется его проверка на то, что код валиден, подготовка
// примитивов статических полей, связываение ссылок на другие классы(если есть).
